;board representation of a chinese checkers board
;borrowed from here http://www.cs.cityu.edu.hk/~acm-hk/checkers.htm

;this is a undirected graph, with the value against each key (node number) 
;is the neighbours in each direction
